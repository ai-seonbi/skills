...
기본 README와 skills.sh용 최신 스킬 지침·참조 문서는 영어입니다. 이 한국어 README와 기존 한국어 사용 가이드를 함께 제공합니다. 아래 터미널 명령은 현재 `main`의 영어 `design-guide` 패키지를 설치합니다. `v0.1.0` ZIP은 당시 배포한 한국어 본문을 보존하는 고정 배포본입니다.
...
2. 과거 한국어 배포본은 [전체 자료 ZIP](https://github.com/ai-seonbi/skills/releases/download/v0.1.0/ai-design-guide.zip)으로 받습니다. 스킬·가이드·실제 요청·비교 이미지가 들어 있습니다. 최신 영어 스킬은 아래 터미널 명령으로 설치하세요.
